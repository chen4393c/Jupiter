...
/*
 * Since TicketMaster API asked to use GeoPoint instead of latitude 
 * and longitude directly in request, we need a helper class to do 
 * GeoHash encoding for us. The code here is copied from an simple 
 * implementation from 
...
public class GeoHash {
	...
	public static void main(String[] args) {
		// Expect to see 'u4pruydq'
		System.out.println(encodeGeohash(44.96381, -93.22926, 8));
	}
}
